...
public class InMemoryCountryRepository : InMemoryRepository<Country>, ICountryRepository
{
  public InMemoryCountryRepository(ILogger<InMemoryRepository<Country>> logger) : base(logger)
  {
    ...
    Data.TryAdd(1, new Country { Id = 2, Name = "Poland" });
    Data.TryAdd(1, new Country { Id = 3, Name = "Ireland" });
    Data.TryAdd(1, new Country { Id = 4, Name = "South Africa" });
    Data.TryAdd(1, new Country { Id = 5, Name = "India" });
  }
